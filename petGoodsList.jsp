...
<%
	ArrayList<goodsBean> gList = gdao.getAllGod();
%>
...
<div class="container border list_container" style="margin-top:60px; padding:40px; width:100%; display:flex;">
	...
	<!-- search -->
	<form class="row g-4" action="gSearch.jsp" method="post">
			...
			<tr>
				...
				<td>
					<button type="button"
							...
							onclick="location.href='petGoodsM.jsp?num=<%=gbean.getNum()%>'">
							수정
					</button>
					<button type="button"
							class="btn btn-danger"
							onclick="location.href='petGoodsDelete.jsp?num=<%=gbean.getNum()%>'">
							삭제
					</button>
				</td>
			</tr>
